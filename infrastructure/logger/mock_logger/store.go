...
// Source: infrastructure/logger/store.go

// Package mock_logger is a generated GoMock package.
package mock_logger

import (
	logger "github.com/duck8823/duci/infrastructure/logger"
...
func (m *MockStore) Get(key []byte, ro *logger.ReadOptions) ([]byte, error) {
...
func (m *MockStore) Has(key []byte, ro *logger.ReadOptions) (bool, error) {
...
func (m *MockStore) Put(key, value []byte, wo *logger.WriteOptions) error {
